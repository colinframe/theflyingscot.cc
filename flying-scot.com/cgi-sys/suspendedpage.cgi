            ...
            <div class="container">
                <div class="additional-info-items">
                    ...
                    <div class="reason-text">
                        <a href="http://www.simplewebhosting.co.uk" id="dynamicProviderLink" title="simplewebhosting.co.uk" rel="noopener noreferrer">Contact your hosting provider</a> for more information.
                    </div>
                </div>
            </div>
        </section>
